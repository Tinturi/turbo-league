export default function RulesPage() {
  const rules = [
    ...
    "В течение одной игровой недели в зачёт идёт только первая игра на каждом герое. Вторая и все последующие игры на том же герое до недельного сброса полностью игнорируются: они не меняют рейтинг и не учитываются в матчах, победах, поражениях, winrate, сериях, графиках и истории лиги.",
    ...
    "Для участия в третьем сезоне нужно внести организационный взнос в размере ЛЯЯЯЯЯМ ДВЕСТИ. Чек прислать в Discord лиги и Саши.",
  ];
