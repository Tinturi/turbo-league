export default function RulesPage() {
  const rules = [
    ...
    "Каждую игровую неделю участник получает 1 заряд на изменение выбранной четвёрки героев. Новые герои начинают действовать с момента подтверждения изменения; уже сыгранные и зачтённые матчи сохраняются по прежней четвёрке.",
    "За каждые 5 поражений подряд без победы между ними участник получает ещё +1 заряд на изменение четвёрки после обновления статистики. Серия из 10 поражений даёт +2 заряда, из 15 — +3 и так далее. Заряды действуют только в текущую игровую неделю.",
